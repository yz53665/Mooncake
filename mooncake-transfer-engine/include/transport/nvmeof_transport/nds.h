 ...
 * @return 0 on success, -1 on failure
 */
int nds_batch_io_get_status(nds_batch_handle_t handle, unsigned min_complete,
    unsigned *event_count, nds_batch_io_events_t *events, const struct timespec *timeout);
